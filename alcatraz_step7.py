#!/usr/bin/env python3
"""
ALCATRAZ Agent Jail OS — Step 7 (Dry-Run vs Live Execution)
...
class ToolGate:
    ...
    def bankr_prompt(self, prompt: str) -> dict:
        ...
        if execution == "dry_run" and any(w in p for w in trade_words):
            self.audit.write(
                "tool_denied",
                tool="bankr",
